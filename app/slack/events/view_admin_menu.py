...
from app.database.retrospective import get_retrospective_by_id
...
async def handle_view_admin_delete_retrospective(
    ...
    """회고 삭제 모달 처리"""
    from app.database.retrospective import delete_retrospective
...
async def handle_view_admin_edit_retrospective(
    ...
    """회고 수정 모달 제출 처리"""
    from app.database.retrospective import update_retrospective
